...
export default function AuthInput({ context }: { context: "sign-in" | "sign-up"; }) {
    ...
    const [banner, setBanner] = useState<{ rawFile: File, modifiedFile: File | null; } | null>(null);
    const [avatar, setAvatar] = useState<{ rawFile: File, modifiedFile: File | null; } | null>(null);
    const [isModalOpen, setIsModalOpen] = useState<{ avatarEdit: boolean | undefined; bannerEdit: boolean | undefined; }>({ bannerEdit: undefined, avatarEdit: undefined });
                    ...
                    <InputX
                        ...
                        endContent={
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <p>{!showConfirmPassword ? "Show confirm password" : "Hide confirm Password"}</p>
                                </TooltipContent>
                            </Tooltip>
                        }
                    />
                                    ...
                                    <React.Fragment>
                                        <Modal
                                            ...
                                            modal={{
                                                ...
                                                content: (
                                                    <div className=''>
                                                        <p className='text-destructive'>Under Construction</p>
                                                    </div>
                                                ),
                                                defaultCloseButton: {
                                                    mobile: "Cancel",
                                                ...
                                                footer: (
                                                    <Button onClick={() => setIsModalOpen((rest) => ({ ...rest, avatarEdit: false }))}>Done</Button>
                                                )
                                            }}
                                        />
                                        ...
                                        <Modal
                                            ...
                                            modal={{
                                                ...
                                                description: 'See how your avatar would look like in your profile.',
                                                content: (
                                                    <div className='border-[2px] flex place-content-center'>
                                                        <img
                                                            className='aspect-square w-[50%] rounded-full object-cover'
                                                            src={URL.createObjectURL(avatar.modifiedFile || avatar.rawFile)}
                                                            alt='Banner preview'
                                                        />
                                                    </div>
                                                ),
                                    ...
                                    <React.Fragment>
                                        <Modal
                                            ...
                                            modal={{
                                                ...
                                                footer: (
                                                    <Button onClick={() => setIsModalOpen((rest) => ({ ...rest, bannerEdit: false }))}>Done</Button>
                                                )
                                            }}
                                        />
                                        ...
                                        <Modal
                                            ...
                                            modal={{
                                                ...
                                                description: 'See how your banner would look like in your profile.',
                                                content: (
                                                    <div className='border-[2px]'>
                                                        <img
                                                            className='aspect-[3/1] rounded-lg object-cover'
                                                            src={URL.createObjectURL(banner.modifiedFile || banner.rawFile)}
                                                            alt='Banner preview'
                                                        />
                                                    </div>
                                                ),
